...
func handle_input(event: InputEvent, game_over: bool, paused: bool):
	...
	elif event.is_action_released("move_left") or event.is_action_released("ui_left"):
	...
	elif event.is_action_released("move_down") or event.is_action_released("ui_down"):
		keys_pressed["down"] = false
	
	elif event.is_action_pressed("rotate") or event.is_action_pressed("ui_up"):
		rotate.emit()
