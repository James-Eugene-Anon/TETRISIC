# Project Custom Instructions: Godot-Python-TETRIS+MUSIC+ROGUE-Game
...
## 3. Anti-Laziness Protocol (For Claude 4.6 Opus/GPT-5.3 Codex/Gemini 3.1 Pro)
- **NO PLACEHOLDERS**: Never use `// ... existing code` or `pass`.
- **Full Refactor**: Provide complete, copy-pasteable blocks for file-based refactoring.
- **Thinking Budget**: For complex tasks, utilize your full thinking budget to analyze cross-file dependencies.
